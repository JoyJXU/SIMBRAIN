...
class STDPMapping(Mapping):
    ...
    def total_area_calculation(self) -> None:
        ...
        ADC_height, ADC_width, sim_shiftadd_area, sim_SarADC_area, sim_comparator_area, sim_mux_area = self.ADC_module.ADC_module_area.ADC_module_cal_area()
        periph_total_area = sim_switch_matrix_row_area + sim_switch_matrix_col_area + sim_shiftadd_area + sim_SarADC_area + sim_comparator_area + sim_mux_area
        self.sim_periph_area = {'sim_switch_matrix_row_area': sim_switch_matrix_row_area,
                             ...
                             'sim_Comparator_Area': sim_comparator_area,'sim_Mux_area': sim_mux_area,
