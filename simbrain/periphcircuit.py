...
class ADC_Module(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.clipping_threshold = 1.486e-10 # Set the clipping threshold
    ...
    def ADC_read(self, mem_i_sequence, total_wire_resistance, high_cut_ratio) -> None:
        ...
        # Apply clipping
        mem_i = self.apply_clipping(mem_i)
        ...
        if self.sim_params['hardware_estimation']:
            ...
            self.ADC_module_power.comparator_energy_calculation(mem_i_sequence=mem_i_sequence)
            self.ADC_module_power.mux_energy_calculation(mem_i_sequence=mem_i_sequence)

        return mem_i
    
    def apply_clipping(self, mem_i):
        comparator_output = self.comparator(mem_i)
        clipped_output = self.mux(comparator_output, mem_i)
    ...
    def mux(self, select_signal, input_signal):
        ...
        return input_signal * select_signal.float()
