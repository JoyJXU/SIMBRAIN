...
class Nodes(torch.nn.Module):
        ...
        **kwargs,
        ...
        if self.traces:
            ...
            if self.device_name != 'trace':
                self.mem_array = MemristorArray(mem_device = mem_device , shape = self.shape)
    ...
    def forward(self, x: torch.Tensor) -> None:
        ...
        if self.traces:
            if self.device_name == 'trace':
                ...
                s = self.s
                self.x = self.mem_array.memristor_compute(s)
    ...
    def reset_state_variables(self) -> None:
        ...
        if self.traces:
            ...
            if self.device_name != 'trace':
                self.mem_array.reset_memristor_variables()
    ...
    def set_batch_size(self, batch_size) -> None:
        ...
        if self.traces:
            ...
            if self.device_name != 'trace':
                self.mem_array.set_batch_size(batch_size = batch_size)
