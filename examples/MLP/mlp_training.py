...
parser.add_argument("--retention_loss", type=bool, default=False) # retention loss, 0: without it, 1: during pulse, 2: no pluse for a long time
...
# %% Multiple test
out_root = 'Accuracy_Results_MLP_train_nonlin_2.95.txt'
multiple_test_no = 50
